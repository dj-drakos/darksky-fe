        ...
        return (
            <div className="main">
                ...
                <div>
                    <h2>DJ Drakos</h2>
                    <p>
                       <img className="bio-pic" src="https://media-exp1.licdn.com/dms/image/C5603AQE287gRluCYbA/profile-displayphoto-shrink_400_400/0/1621478870959?e=1631145600&v=beta&t=A1bkeCBGJPhO_ikmcv5avaRxNN-e-LG8DQn97NNW568" alt="DJ Drakos"></img>
                    </p>
                    <p>
                        Insert Bio Here
                    </p>
                ...
                <div>
                    <h2>Kubisiak</h2>
                    <p>
                    <img className="bio-pic" src="https://media-exp1.licdn.com/dms/image/D5635AQHCPhSDFCUp1A/profile-framedphoto-shrink_400_400/0/1623739955189?e=1625878800&v=beta&t=uUUMkjjx_M6K5E9LjB6M5-UMwWCFS0TojCj8Tc-SjrM" alt="Kubisiak"></img>
                    </p>
                    <p>
                        Insert Bio Here
                    </p>
                ...
                <div>
                    <h2>Sofia Tejada</h2>
                    <p>
                        <img className="bio-pic" src="https://media-exp1.licdn.com/dms/image/C4E03AQGlkWEQ4EAexQ/profile-displayphoto-shrink_400_400/0/1620661766468?e=1631145600&v=beta&t=rJPfZMro0k1beU2fxE5-xgH-GiC6tNetet_MVxpKTcE" alt="Sofia Tejada"></img>
                    </p>
                    <p>
                ...
                <div>
                    <h2>Isaac Ewing</h2>
                    <p>
                        <img className="bio-pic" src="https://media-exp1.licdn.com/dms/image/C4E03AQG9gSEPQJjNYg/profile-displayphoto-shrink_400_400/0/1620148404124?e=1631145600&v=beta&t=QvyV9IKqEmGUY9YTxmcBmfyPzVNYudBEVVbMN9sAWFQ" alt="Isaac Ewing"></img>
                    </p>
                    <p>
                        Insert Bio Here
                    </p>
                ...
                <div>
                    <h2>Ben Francka</h2>
                    <p>
                        <img className="bio-pic" src="https://media-exp1.licdn.com/dms/image/C4E03AQHTL9yonVG_eA/profile-displayphoto-shrink_400_400/0/1620147576714?e=1631145600&v=beta&t=6TXXJUgjfP3bLZf1vbDi_1_BPyYzwx7axotUvhqRWiQ" alt="Ben Francka"></img>
                    </p>
                    <p>
                ...
                <div>
                    ...
                    <p>
                        ...
                        was used to obtain a live updated astronomy picture and video for our main page.
                    </p>
                    <p>
